...
.scorecard{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:1.5rem;margin:2rem 0;max-width:none}
...
@media(max-width:600px){body{padding:.5rem 1rem}h1{font-size:1.4rem}h2{font-size:1.2rem}table{font-size:.8rem}.tab-bar{padding:0.5rem .75rem;gap:.25rem}.tab-btn{padding:0.5rem 0.8rem;font-size:.85rem}.scorecard{grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:1rem}}
`;
...
<div class="sc-label">Claims Analyzed</div>
<div class="sc-sublabel">Every claimed 'win' reviewed against source data</div>
</div>
<div class="sc-card accent">
<div class="sc-number">0</div>
<div class="sc-label">Unique to Dome</div>
<div class="sc-sublabel">No claim produces a result the globe model disagrees with that the dome uniquely explains</div>
</div>
<div class="sc-card">
<div class="sc-number">11</div>
<div class="sc-label">Self-Contradicted</div>
<div class="sc-sublabel">The dome's own math produces results that contradict the author's claims</div>
</div>
<div class="sc-card">
<div class="sc-number">14/20</div>
<div class="sc-label">Share One Constant</div>
<div class="sc-sublabel">The '9.2-sigma' dashboard reuses a single fitted number</div>
</div>
</div>
