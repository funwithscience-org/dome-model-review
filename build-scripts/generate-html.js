...
<p><strong>Test 1 — Sydney–Perth distance (claimed confirmed):</strong> The dome predicts 4,352 km. The globe geodesic (shortest surface path) is 3,291 km, confirmed by direct flight paths (~3,290 km). The Indian Pacific railway covers 4,352 km — but this route detours south through Adelaide, adding ~1,061 km over the straight-line distance. The dome prediction matches the railway exactly (4,352 km), which raises the question: was this derived from dome geometry, or calibrated to a known railway distance? The proper geometric test is straight-line distance, which direct flights confirm at ~3,290 km (matching the globe). The driving distance (~3,935 km) is between the two, reflecting road detours but not the Adelaide loop. Comparing a geometric prediction to a circuitous railway is not a valid test of either model; the direct flight distance is the clean measurement, and it matches the globe.</p>
